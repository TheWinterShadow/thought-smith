...
struct HelpGuideView: View {
    ...
    enum GuideType: String, CaseIterable {
        ...
        case viewWelcome = "View Welcome Screen"
        ...
        var icon: String {
            ...
            case .viewWelcome: return "hand.wave.fill"
            }
        }
    ...
    var body: some View {
        NavigationView {
            ...
            List {
                ForEach(GuideType.allCases, id: \.self) { guide in
                    if guide.isAction {
                        ...
                        NavigationLink(destination: GuideDetailView(guide: guide, dismiss: dismiss)) {
                            Label(guide.rawValue, systemImage: guide.icon)
                        }
                    }
                }
            ...
            // Content - Default detail view (for iPad split view)
            GuideDetailView(guide: selectedGuide, dismiss: dismiss)
        }
...
struct MarkdownContentView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 20) {
            ...
            case .viewWelcome:
                // This case is handled as an action, not a navigation destination
                EmptyView()
            }
        }
    }
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 16) {
                MarkdownContentView(guide: guide)
            }
            .padding()
        }
        .navigationTitle(guide.rawValue)
        .navigationBarTitleDisplayMode(.inline)
        .toolbar {
